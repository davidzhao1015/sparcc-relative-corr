...
Applied igraph to visualize network based on SparCC correlation matrix. The [R graph gallery](https://r-graph-gallery.com/250-correlation-network-with-igraph.html) provides detailed R codes to implement igraph package. 
...
Refer to the [R graph gallery](https://r-graph-gallery.com/hierarchical-edge-bundling.html) 
